					                        ...
					                        {{csrf_field()}}
												...
												<div class="row">
													...
													<div class="col-lg-7 prod-name">
														<input type="text" class="input-field" placeholder="{{ $langg->lang632 }}" value="{{ $data->name }}" name="name" required="">
														<div class="strain-search d-none">
														
															<input type="text" data-href="{{ route('vendor-strain-search') }}" id="strain-search-field" class="input-field" placeholder="{{ $langg->lang632 }}" value="{{ $data->name }}" name="name-d" required="">
												...
												<div class="row">
													...
													<div class="col-lg-7">
															<select id="location" name="location_id" required="">
																...
																@foreach($locs as $loc)
																	<option data-href="{{ route('vendor-policy-load', $loc->id) }}" value="{{$loc->id}}" {{$loc->id == $data->location_id ? "selected":""}} >{{$loc->address}} {{$loc->state}} ({{$loc->location_name}})</option>
																@endforeach
						                                     </select>
													</div>
												</div>
																	...
																	@foreach($data->size as $key => $data1)
																		...
																		<div  class="row">
																				...
																				<div class="col-md-4 col-sm-6">
																					...
																					<input type="number" name="size_price[]" class="input-field" placeholder="{{ $langg->lang653 }}" min="0" step="0.1" value="{{ $data->size_price[$key] }}">
																				</div>
																			</div>
																		</div>
																	@endforeach
												...
												<div id="subcatAttributes">
													...
													@if (!empty($subAttributes))
														@foreach ($subAttributes as $subAttribute)
															@php
																$checkattr = is_array($selectedAttrs) && array_key_exists($subAttribute->input_name,$selectedAttrs);
															@endphp
															<div class="row">
																<div class="col-lg-4">
																	<div class="left-area">
																...
																<div class="col-lg-7">
																	<ul class="list">
																		<li>
																			<input class="checkclick2" name="{{$subAttribute->input_name}}_check" type="checkbox" id="{{$subAttribute->input_name}}_check" value="1" @if($checkattr) checked @endif>
																			<label for="{{$subAttribute->input_name}}_check">Allow Product {{$subAttribute->name}}</label>
																		</li>
																	</ul>
																</div>
															</div>
																 ...
																 <div class="col-lg-7">
																		 ...
																		 @foreach ($subAttribute->attribute_options as $option)
																			 ...
																			 <div class="row">
																			    ...
																			    <div class="col-lg-6 {{ $subAttribute->price_status == 0 ? 'd-none' : '' }}">
																			       <div class="row">
																			          <div class="col-2">
																			             +
																			          </div>
												...
												<div id="childcatAttributes">
													...
													@if (!empty($childAttributes))
														@foreach ($childAttributes as $childAttribute)
															@php
																$checkattr = is_array($selectedAttrs) && array_key_exists($childAttribute->input_name,$selectedAttrs);
															@endphp
															<div class="row">
																<div class="col-lg-4">
																	<div class="left-area">
																...
																<div class="col-lg-7">
																	<ul class="list">
																		<li>
																			<input class="checkclick2" name="{{$childAttribute->input_name}}_check" type="checkbox" id="{{$childAttribute->input_name}}_check" value="1" @if($checkattr) checked @endif>
																			<label for="{{$childAttribute->input_name}}_check">Allow Product {{$childAttribute->name}}</label>
																		</li>
																	</ul>
																</div>
															</div>
																 ...
																 <div class="col-lg-7">
																	 ...
																	 @foreach ($childAttribute->attribute_options as $optionKey => $option)
																		 ...
																		 <div class="row">
																				...
																				<div class="col-lg-6 {{ $childAttribute->price_status == 0 ? 'd-none' : '' }}">
																					 <div class="row">
																							<div class="col-2">
																								 +
																							</div>
																...
																<div class="feature-tag-top-filds" id="whole-section">
																	...
																	<div class="feature-area">
																		...
																		<div class="row">
																			...
																			<div class="col-lg-6">
																			<input type="number" name="whole_sell_discount[]" step="0.01" class="input-field" placeholder="{{ $langg->lang662 }}" min="0" value="{{ $data->whole_sell_discount[$key] }}" required="">
																			</div>
																		</div>
																	</div>
																	...
																	<div class="feature-area">
																		...
																		<div class="row">
																			...
																			<div class="col-lg-6">
																			<input type="number" name="whole_sell_discount[]" class="input-field" placeholder="{{ $langg->lang662 }}" min="0" step="0.01"/>
																			</div>
																		</div>
																	</div>
												...
												<div class="row prod-effect d-none">
													...
													<div class="col-lg-7">
														<div class="text-editor">
															<textarea class="form-control" id="effects" name="effects" rows="5">{{$data->effects}}</textarea>
														</div>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<div class="text-editor">
															<textarea name="details" id="details" class="nic-edit-p" rows="5">{{$data->details}}</textarea>
														</div>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<div class="text-editor">
															<textarea name="policy" id="policy" class="nic-edit-p" rows="5">{{$data->policy}}</textarea>
														</div>
													</div>
												</div>
												...
												<div class="row prod-parent d-none">
													...
													<div class="col-lg-7">
														<div class="text-editor">
															<textarea class="form-control" name="parent" id="parent" rows="5">{{ $data->parent }}</textarea>
														</div>
													</div>
												</div>
						                        ...
						                        <div class="{{ ($data->meta_tag == null && strip_tags($data->meta_description) == null) ? "showbox":"" }}">
						                          ...
						                          <div class="row">
						                            ...
						                            <div class="col-lg-7">
						                              <div class="text-editor">
						                                <textarea name="meta_description" class="input-field" placeholder="{{ $langg->lang685 }}" rows="5">{{ $data->meta_description }}</textarea>
						                              </div>
						                            </div>
						                          </div>
						                        </div>
														...
														<div class="featured-keyword-area">
															...
															<div class="feature-tag-top-filds" id="feature-section">
																...
																<div class="feature-area">
																	...
																	<div class="row">
																		<div class="col-lg-6">
																		<input type="text" name="features[]" @if($key==0) id="feature"  @endif class="input-field" placeholder="{{ $langg->lang687 }}" value="{{ $data->features[$key] }}">
																		</div>
																...
																<div class="feature-area">
																	...
																	<div class="row">
																		<div class="col-lg-6">
																		<input type="text" name="features[]" id="feature" class="input-field" placeholder="{{ $langg->lang687 }}">
																		</div>
												...
												<div class="row" id="is_verified_section" @if($data->category->skip_license == 1) style="display: none;" @endif>
													<div class="col-lg-4">
														<div class="left-area">
													...
													<div class="col-lg-7">
														<ul class="list">
															<li>
																<input name="is_verified" type="checkbox" id="is_verified" value="1" @if($data->is_verified) checked @endif>
...
$("#childcatAttributes").on("change",".checkclick2",  function() {
  ...
  $(document).ready(function() {
	...
	$("#cat").on('change', function() {
		...
		$.ajax({
			type: 'POST',
			url: '{{ route("vendor-category-license-setting") }}',
			data: {
			...
			success: function(response) {
				if(response == 1) {
					if($("#is_verified").is(":checked") == true) {
						$("#is_verified").removeAttr("checked");
					}

					$("#is_verified_section").hide();
				}
				else {
					$("#is_verified_section").show();
				}
			}
		})
	})
	...
	if (cat_id == "16" || cat_id == "17" || cat_id == "18") {
                $(".prod-name>input").addClass("d-none");
                $(".prod-name>input").attr('name', 'name-d');
                $("#strain-search-field").attr('name', 'name');

                $(".strain-search").removeClass("d-none");
                $(".prod-effect").removeClass("d-none");
                $(".prod-parent").removeClass("d-none");
            }
