...
Route::prefix('admin')->group(function () {
    ...
    Route::group(['middleware' => 'permissions:customers'], function () {
        ...
        Route::get('/users/track/datatables', 'Admin\UserController@trackdatatables')->name('admin-user-trackdatatables'); //JSON REQUEST
        Route::get('/users/track/{flag}', 'Admin\UserController@track')->name('admin-user-track');
    });
    ...
    Route::group(['middleware' => 'permissions:vendors'], function () {
        ...
        Route::get('/vendors/locations/datatables', 'Admin\VendorController@locations_datatables')->name('admin-vendor-locations-datatables');
        Route::get('/vendors', 'Admin\VendorController@index')->name('admin-vendor-index');
        Route::get('/vendors/locations', 'Admin\VendorController@locations')->name('admin-vendor-locations');
    ...
    Route::group(['middleware' => 'permissions:vendor_subscription_plans'], function () {
        ...
        Route::get('/text_campaign/detail_edit/{id}', 'Admin\CampaignController@edit_detail')->name('admin-campaign-detail-edit');
        Route::post('/text_campaign/detail_edit/{id}', 'Admin\CampaignController@update_detail')->name('admin-campaign-detail-update');
        Route::get('/text_campaign/detail_delete/{id}', 'Admin\CampaignController@destroy_detail')->name('admin-campaign-detail-delete');

        Route::get('/text_campaign', 'Admin\CampaignController@text_campaign')->name('admin-campaign');
        Route::get('/text_campaign/datatables', 'Admin\CampaignController@campaign_datatables')->name('admin-campaign-datatables'); //JSON REQUEST
        Route::post('/text_campaign/approve', 'Admin\CampaignController@campaign_approve')->name('admin-campaign-approve');
        Route::post('/text_campaign/deny', 'Admin\CampaignController@campaign_deny')->name('admin-campaign-deny');

        Route::get('/text_campaign/history', 'Admin\CampaignController@text_campaign_history')->name('admin-campaign-history');
        Route::get('/text_campaign/history_datatables', 'Admin\CampaignController@campaign_history_datatables')->name('admin-campaign-history-datatables'); //JSON REQUEST
    ...
    //------------ ADMIN VERIFIED PLAN SECTION ------------

    Route::group(['middleware' => 'permissions:verification_plan'], function () {

        Route::get('/verification/datatables', 'Admin\VerificationPlanController@datatables')->name('admin-verification-datatables');
        Route::get('/verification', 'Admin\VerificationPlanController@index')->name('admin-verification-index');
        Route::get('/verification/create', 'Admin\VerificationPlanController@create')->name('admin-verification-create');
        Route::post('/verification/create', 'Admin\VerificationPlanController@store')->name('admin-verification-store');
        Route::get('/verification/edit/{id}', 'Admin\VerificationPlanController@edit')->name('admin-verification-edit');
        Route::post('/verification/edit/{id}', 'Admin\VerificationPlanController@update')->name('admin-verification-update');
        Route::get('/verification/delete/{id}', 'Admin\VerificationPlanController@destroy')->name('admin-verification-delete');

        Route::get('/verification/approved', 'Admin\VerificationPlanController@approve')->name('admin-verification-approved');
        Route::get('/verification/approve_datatables', 'Admin\VerificationPlanController@approve_datatables')->name('admin-verification-approve-datatables');
        
        Route::get('/verification/pending'  , 'Admin\VerificationPlanController@pending')->name('admin-verification-pending');
        Route::get('/verification/pending_datatables', 'Admin\VerificationPlanController@pending_datatables')->name('admin-verification-pending-datatables');

        Route::post('/verification/status_approve'  , 'Admin\VerificationPlanController@update_approve')->name('admin-verification-update-approve');
        Route::get('/verification/status_pending/{id}'  , 'Admin\VerificationPlanController@update_pending')->name('admin-verification-update-pending');
    ...
    //------------  ADMIN VERIFIED PLAN SECTION ENDS ------------
    ...
    Route::group(['middleware' => 'permissions:messages'], function () {
        ...
        Route::get('/send_message', 'Admin\MessageController@send_message')->name('admin-message-sendmessage');
        Route::post('/send_text', 'Admin\MessageController@send_text_message')->name('admin-message-sendtext');
    });
    ...
    Route::group(['middleware' => 'permissions:general_settings'], function () {
        ...
        Route::get('/general-settings/prodimage', 'Admin\GeneralSettingController@prodimage')->name('admin-gs-prodimage');
        ...
        Route::get('/general-settings/solo', 'Admin\GeneralSettingController@solo')->name('admin-gs-solo');
        Route::get('/general-settings/solo-mode/{status}', 'Admin\GeneralSettingController@solo_mode')->name('admin-gs-solo-mode');
        Route::post('/general-settings/solo-save', 'Admin\GeneralSettingController@solo_save')->name('admin-gs-solo-save');

        Route::get('/general-settings/agepopup', 'Admin\GeneralSettingController@agepopup')->name('admin-gs-agepopup');
        Route::get('/general-settings/agepopup/{status}', 'Admin\GeneralSettingController@active_agepopup')->name('admin-gs-agepopup-status');
        Route::post('/general-settings/agepopup', 'Admin\GeneralSettingController@save_agepopup')->name('admin-gs-agepopup-save');
        ...
        Route::get('/general-settings/slider_location/{status}', 'Admin\GeneralSettingController@slider_location')->name('admin-gs-slider-location');
        Route::get('/general-settings/stock/{status}', 'Admin\GeneralSettingController@stock')->name('admin-gs-stock');
        Route::get('/general-settings/age/{status}', 'Admin\GeneralSettingController@age')->name('admin-gs-age');
...
//------------ PRODUCT VIEW SETTING SECTION -------------

Route::get('/productview/home', 'Admin\ProductViewSettingController@homesetting')->name('admin-productview-home');
Route::post('/productview/home', 'Admin\ProductViewSettingController@homesetting_store')->name('admin-productview-home-store');

Route::get('/productview/filtered', 'Admin\ProductViewSettingController@filteredsetting')->name('admin-productview-filtered');
Route::post('/productview/filtered', 'Admin\ProductViewSettingController@filteredsetting_store')->name('admin-productview-filtered-store');

Route::get('/productview/vendor', 'Admin\ProductViewSettingController@vendorsetting')->name('admin-productview-vendor');
Route::post('/productview/vendor', 'Admin\ProductViewSettingController@vendorsetting_store')->name('admin-productview-vendor-store');

Route::get('/productview/color', 'Admin\ProductViewSettingController@colorsetting')->name('admin-productview-color');
Route::post('/productview/color', 'Admin\ProductViewSettingController@colorsetting_store')->name('admin-productview-color-store');


//------------ PRODUCT VIEW SETTING SECTION END ---------
...
// User Get Verified Begin
    Route::get('/verified/get', 'User\VerifiedController@index')->name('user-verified-index');
    Route::post('verified/store', 'User\VerifiedController@store')->name('user-verified-store');

// User Get Verified End
...
// ************************************ VENDOR SECTION **********************************************
    ...
    Route::prefix('vendor')->group(function () {
        ...
        Route::group(['middleware' => 'vendor'], function () {
            ...
            Route::post('/send/message', 'Vendor\VendorController@sendmessage')->name('vendor-send-email');

            Route::get('/verified', 'Vendor\VendorController@verified')->name('vendor-email-verified');
            ...
            Route::post('/return_policy/store', 'Vendor\PolicyController@store')->name('vendor-return-policy-store');

            Route::group(['middleware' => 'vendor_itital'], function() {
                // Vendor Dashboard
                ...
                // Vedor Add Product Strain Search Autocomplete
                
                Route::get('/strain/search', 'Vendor\VendorController@searchStrain')->name('vendor-strain-search');
                Route::get('/straingallery/{id}', 'Vendor\VendorController@getStrainGalleries')->name('vandor-strain-gelleries');

                // End Vendor Add Product Stranin Search Autocomplete
                ...
                Route::get('/locations/datatables', 'Vendor\LocationController@datatables')->name('vendor-location-datatables'); //JSON REQUEST
                Route::get('/locations', 'Vendor\LocationController@index')->name('vendor-location-index');
                
                Route::get('/locations/edit/{id}', 'Vendor\LocationController@edit')->name('vendor-location-edit');
                Route::post('/locations/edit/{id}', 'Vendor\LocationController@update')->name('vendor-location-update');
                Route::get('/locations/delete/{id}', 'Vendor\LocationController@destroy')->name('vendor-location-delete');

                //------------ VENDOR LOCATION SECTION ENDS------------
                
                //------------ VENDOR RETURN POLICY SECTION ------------

                Route::get('/return_policy', 'Vendor\PolicyController@index')->name('vendor-return-policy');
                Route::get('/return_policy/datatables', 'Vendor\PolicyController@datatables')->name('vendor-return-policy-datatables');
                Route::get('/return_policy/edit/{id}', 'Vendor\PolicyController@edit')->name('vendor-return-policy-edit');
                Route::get('/return_policy/delete/{id}', 'Vendor\PolicyController@destroy')->name('vendor-return-policy-delete');
                Route::get('/return_policy/status/{id1}/{id2}', 'Vendor\PolicyController@status')->name('vendor-return-policy-status');
                Route::post('/return_policy/update/{id}', 'Vendor\PolicyController@update')->name('vendor-return-policy-update');
                Route::get('/load/return_policy/{location_id}/', 'Vendor\PolicyController@load')->name('vendor-policy-load'); //JSON REQUEST

                //------------ VENDOR RETURN POLICY ENDS------------
                ...
                Route::post('/products/category-license-setting', 'Vendor\ProductController@category_license')->name('vendor-category-license-setting');
                ...
                Route::get('/campaign/datatables', 'Vendor\CampaignController@datatables')->name('vendor-campaign-datatables');
                Route::get('/campaign/add', 'Vendor\CampaignController@add')->name('vendor-campaign-add');
                Route::post('/campaign/store', 'Vendor\CampaignController@store')->name('vendor-campaign-store');

                Route::get('/campaign/purchase/{id}', 'Vendor\CampaignController@purchase')->name('vendor-campaign-purchase');
                Route::post('/campaign/buy', 'Vendor\CampaignController@buy')->name('vendor-campaign-buy');
                // VENDOR Campaign SECTION END
            });
