						...
						<div class="content-area">
										...
										<div class="product-description">
											...
											<form id="geniusform" action="{{route('vendor-prod-store')}}" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													...
													<div class="col-lg-7 prod-name">
														...
														<div class="strain-search d-none">
															...
															<input type="text" data-href="{{ route('vendor-strain-search') }}" id="strain-search-field" class="input-field" placeholder="{{ $langg->lang632 }}" name="name-d" required="">
												...
												<div class="row">
													...
													<div class="col-lg-7 strainchecker">
                            ...
                            <div class="checkbox-wrapper">
                              ...
                              <label for="conditionCheck">{{ $langg->lang633 }}</label>
                                              ...
                                              @foreach($locs as $loc)
                                                  <option data-href="{{ route('vendor-policy-load', $loc->id) }}" value="{{$loc->id}}">{{$loc->address}} {{$loc->state}} ({{$loc->location_name}})</option>
                                              @endforeach
						                                     </select>
													</div>
												</div>
															...
															<div class="feature-tag-top-filds" id="whole-section">
																<div class="feature-area">
																	...
																	<div class="row">
																		...
																		<div class="col-lg-6">
											                            <input type="number"  step="0.01" name="whole_sell_discount[]" class="input-field" placeholder="{{ $langg->lang662 }}" min="0" />
																		</div>
																	</div>
																</div>
															</div>
											...
											<div class="showbox">
						                        ...
						                        <div class="showbox">
						                          ...
						                          <div class="row">
						                            ...
						                            <div class="col-lg-7">
						                              <div class="text-editor">
						                                <textarea name="meta_description" class="input-field" placeholder="{{ $langg->lang685 }}" rows="5"></textarea>
						                              </div>
						                            </div>
						                          </div>
						                        </div>
														...
														<div class="featured-keyword-area">
															...
															<div class="feature-tag-top-filds" id="feature-section">
																<div class="feature-area">
																	...
																	<div class="row">
																		<div class="col-lg-6">
																		<input type="text" id="feature" name="features[]" class="input-field" placeholder="{{ $langg->lang687 }}">
																		</div>
...
// Gallery Section Insert
  ...
  $(document).on('click', '.remove-img' ,function() {
	...
	if(id.includes('assets/images/strains')) {
		var asset_list = $("[name=strain-feature-gallery]").val();
		asset_list = asset_list.replace(id + ',', "");
