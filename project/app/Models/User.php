...
class User extends Authenticatable
{
    ...
    protected $fillable = ['name', 'photo', 'zip', 'residency', 'city', 'country', 'position', 'address', 'phone', 'fax', 'email', 'password', 'affilate_code', 'verification_link', 'shop_name', 'owner_name', 'shop_number', 'shop_address', 'reg_number', 'shop_message', 'is_vendor', 'shop_details', 'shop_image', 'f_url', 'g_url', 't_url', 'l_url', 'f_check', 'g_check', 't_check', 'l_check', 'shipping_cost', 'date', 'mail_sent', 'is_verified', 'terms_condition', 'terms_condition_inital'];
    ...
    {
        return $this->hasMany('App\Models\ReturnPolicy');
    }
    ...
    {
        return $this->hasMany('App\Models\Subcategory', 'user_id');
    }

    public function locations()
    {
        return $this->hasMany('App\Models\StoreLocations', 'user_id');
    }

    public function childcategories()
    {
        return $this->hasMany('App\Models\Childcategory', 'user_id');
    }

    public function adproducts()
    {
        return $this->hasMany('App\Models\AdvertisingProduct', 'vendor_id');
    }
