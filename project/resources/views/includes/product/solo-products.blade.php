    ...
    @if (count($solo_products) > 0)
        ...
        <div class="col-lg-12">
            <div class="page-center mt-5">
                {!! $solo_products->appends(['search' => request()->input('search')])->links() !!}
            </div>
        </div>
    @else
        <div class="col-lg-12">
        ...
        @foreach ($solo_products as $key => $solo_prod)
            ...
            <a href="{{ route('front.product', $solo_prod->slug) }}" class="prod-item item">            
                <div class="prod-init">
                    ...
                    @if ($solo_prod->showParent() && $solo_prod->showParent() != '<br>')
                        <p class="prod-details" style="color: {{ $colorsetting_style2 && $colorsetting_style2->sub_detail_color? $colorsetting_style2->sub_detail_color : '#333333' }}">	
                            <small>Parents: <?php echo $solo_prod->showParent();  ?></small>
                        </p>
                    @endif
                ...
                <div class="info">
                        ...
                        <h4 class="price">{{ $solo_prod->setCurrency() }} <del><small>{{ $solo_prod->showPreviousPrice() }}</small></del></h4>
                        <h5 class="name">{{ $solo_prod->showName() }}
                        @if ($solo_prod->showParent() && $solo_prod->showParent() != '<br>')
                            <p class="prod-details" style="color: {{ $colorsetting_style2 && $colorsetting_style2->sub_detail_color? $colorsetting_style2->sub_detail_color : '#333333' }}">	
                                <small>Parents: <?php echo $solo_prod->showParent();  ?></small>
                            </p>
