                    ...
                    <div class="product-description">
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{route('admin-prod-store')}}" method="POST"
                                ...
                                @foreach($locs as $loc)
                                    <option data-href="{{ route('admin-policy-load', $loc->id) }}" value="{{$loc->id}}">{{$loc->address}} {{$loc->state}} ({{$loc->location_name}})</option>
                                @endforeach
                                                </select>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-7">
                                            <div class="text-editor">
                                                <textarea name="meta_description" class="input-field"
                                                          placeholder="{{ __('Meta Description') }}" rows="5"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
