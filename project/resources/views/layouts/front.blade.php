...
<head>
    ...
    <!-- stylesheet -->
        ...
        <!--Updated CSS-->
        <link rel="stylesheet" href="{{ asset('assets/front/css/styles.php?color='.str_replace('#','',$gs->colors).'&amp;'.'header_color='.str_replace('#','',$gs->header_color).'&amp;'.'footer_color='.str_replace('#','',$gs->footer_color).'&amp;'.'copyright_color='.str_replace('#','',$gs->copyright_color).'&amp;'.'category_color='.str_replace('#','',$gs->category_color).'&amp;'.'menu_color='.str_replace('#','',$gs->menu_color).'&amp;'.'menu_bg_color='.str_replace('#','',$gs->menu_bg_color).'&amp;'.'menu_hover_color='.str_replace('#','',$gs->menu_hover_color)) }}">
            ...
            <div class="col-lg-2 col-sm-6 col-5 remove-padding">
                <div class="logo">
                    <a href="{{ route('front.index') }}">
                        <img src="{{asset('assets/images/'.$gs->logo)}}" alt="" width="100" height="100">
                    </a>
                </div>
            </div>
                    ...
                    <div class="categories_menu_inner">
                        <ul>
                            @if($gs->solo_mode == 1 && !empty($gs->solo_category))
                                ...
                                <li class="{{count($solo_category_info->subs) > 0 ? 'dropdown_list':''}}">
                                    @if(count($solo_category_info->subs) > 0)
                                        <div class="img">
                                            <img src="{{ asset('assets/images/categories/'.$solo_category_info->photo) }}" alt="">
                                        </div>
                                        <div class="link-area">
                                            <span><a href="{{ route('front.category', $solo_category_info->slug) }}">{{ $solo_category_info->name }}</a></span>
                                            @if(count($solo_category_info->subs) > 0)
                                                <a href="javascript:;">
                                    ...
                                    @else
                                        <a href="{{ route('front.category',$solo_category_info->slug) }}">
                                            <img src="{{ asset('assets/images/categories/'.$solo_category_info->photo) }}"> {{ $category->name }}
                                        </a>
                                    @endif
                                    ...
                                    @if(count($solo_category_info->subs) > 0)
                                        @php
                                            $ck = 0;
                                            foreach($solo_category_info->subs as $subcat) {
            ...
            <div class="col-lg-9 col-md-6 mainmenu-wrapper remove-padding">
                <nav hidden>
                    ...
                    <ul class="menu">
                        ...
                        @endif
                        <li><a href="{{ route('front.strain') }}">Strain</a></li>
