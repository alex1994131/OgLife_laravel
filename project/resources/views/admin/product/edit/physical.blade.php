                            ...
                            <form id="geniusform" action="{{route('admin-prod-update',$data->id)}}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 prod-name">
                                        ...
                                        <div class="strain-search d-none">
                                            ...
                                            <input type="text" data-href="{{ route('admin-strain-search') }}" id="strain-search-field" class="input-field" placeholder="{{ __('Enter Product Name') }}" value="{{ $data->name }}" name="name-d" required="">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <div class="checkbox-wrapper">
                                            <input type="checkbox" name="product_condition_check" class="checkclick"
                                                   id="conditionCheck"
                                                   value="1" {{ $data->product_condition != 0 ? "checked":"" }}>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 col-sm-6">
                                                                    ...
                                                                    <input type="number" name="size_qty[]"
                                                                           class="input-field" placeholder="Size Qty"
                                                                ...
                                                                <div class="col-md-4 col-sm-6">
                                                                    ...
                                                                    <input type="number" name="size_price[]"
                                                                           ...
                                                                           value="{{ $data->size_price[$key] }}" step="0.01">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                    ...
                                                    <div class="size-area">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4 col-sm-6">
                                                                ...
                                                                <input type="number" name="size_price[]"
                                                                       class="input-field" placeholder="Size Price"
                                        ...
                                        <ul class="list">
                                            <li>
                                                <input class="checkclick1" name="color_check" type="checkbox"
                                                       id="check3" value="1" {{ !empty($data->color) ? "checked":"" }}>
                                ...
                                <div class="{{ $data->measure == null ? 'showbox' : '' }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-1"></div>
                                        <div class="col-lg-3 {{ in_array($data->measure,explode(',', 'Gram,Kilogram,Litre,Pound')) ? 'hidden' : '' }}"
                                             id="measure">
                                ...
                                <div class="{{ ($data->meta_tag == null && strip_tags($data->meta_description) == null) ? "showbox":"" }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="text-editor">
                                                <textarea rows="5" name="meta_description" class="input-field"
                                            ...
                                            <div class="feature-tag-top-filds" id="feature-section">
                                                ...
                                                @else
                                                    ...
                                                    <div class="feature-area">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <input type="text" id="feature" name="features[]" class="input-field"
                                                                       placeholder="{{ __('Enter Your Keyword') }}">
                                                            </div>
